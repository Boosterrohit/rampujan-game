...
export default function Home() {
  ...
  const features = [
    ...
    {
      icon: Zap,
      title: "Free Spins (3 per day)",
      description: "Daily free spins with amazing prizes",
      path: "/free-spin",
    },
    {
      icon: Gift,
      title: "Prize Chat",
      description: "Chat and claim your earned rewards",
      path: "/prize-chat",
    },
  ]
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-4 mb-8">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Discover all the exciting features we offer to enhance your gaming experience
            </p>
          </div>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" onClick={() => navigate("/free-spin")} className="flex justify-center items-center h-10">
      ...
      <section className="px-4 py-20 md:py-32">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <Button size="lg" onClick={() => navigate("/free-spin")} className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 h-12">
              <ShipWheel className="w-5 h-5 mr-2" />
              Start Playing Now
            </Button>
          </div>
      ...
      <section className="px-4 py-20 md:py-32 bg-gradient-to-br from-card/30 via-background to-card/20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Discover our collection of exciting games. Each game offers unique challenges and amazing rewards!
            </p>
          </div>
            ...
            {availableGames.slice(0, 14).map((game) => (
              ...
              >
                ...
                <div className="absolute inset-0">
                  ...
                  ></div>
                  <div className={`absolute inset-0 bg-gradient-to-br dark:from-black/30 dark:to-gray-900/30 from-white/40 to-gray-200/40`}></div>
                </div>

                <CardContent className="relative p-3 md:p-6 text-center space-y-2 md:space-y-4">
                  {/* Game Icon */}
                  <div className={`w-12 h-12 md:w-20 md:h-20 overflow-hidden mx-auto rounded-full bg-gradient-to-br ${game.color} flex items-center justify-center text-2xl md:text-3xl shadow-lg group-hover:scale-110 transition-transform duration-300 ring-2 md:ring-4 dark:ring-white/20 ring-black/20`}>
                    {/* {game.icon} */}
                ...
                {/* Decorative Corner */}
                <div className={`absolute top-0 right-0 w-0 h-0 border-l-[15px] md:border-l-[20px] border-l-transparent border-t-[15px] md:border-t-[20px] border-t-${game.color.split('-')[1]}/30`}></div>
              </Card>
            ))}
          </div>
          ...
          <div className="text-center mt-12">
            ...
            <Button size="lg" variant="outline" onClick={() => navigate("/free-spin")}>
