    ...
    <div className="space-y-6">
      ...
      <Card className="bg-[#252937] border-gray-600">
        <CardHeader>
          ...
          <CardDescription className="text-gray-400">List of all players</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4 mb-6">
            <Input placeholder="Search players..." className="max-w-sm text-white border-white" />
          </div>
